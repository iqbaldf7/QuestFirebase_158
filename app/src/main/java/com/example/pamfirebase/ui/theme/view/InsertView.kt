...
fun InsertMhsView(
    ...
    val uiState = viewModel.uiState  //State utama untuk load, succes, error
...
fun FormMahasiswa(
    ...
    Column(
        ...
        OutlinedTextField(
            ...
            onValueChange = {
                mahasiswaEvent.copy(judulSkripsi = it)
            },
